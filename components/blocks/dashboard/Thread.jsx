...
const Thread = (props) => {
  const scrollableThreadRef = React.createRef(null);
  const scrollDown = () => {
    scrollableThreadRef.current.scrollTop = scrollableThreadRef.current.scrollHeight;
  };
  const scrollTop = () => {
    scrollableThreadRef.current.scrollTop = 0;
  };
    return (
      <Wrapper>
          ...
          {({ loading, error, data: { thread } }) => {
            ...
            return (
              <>
                ...
                <ThreadScrollable ref={scrollableThreadRef}>
